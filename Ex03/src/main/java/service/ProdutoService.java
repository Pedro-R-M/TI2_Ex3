...
public class ProdutoService {
	...
	public void makeForm(int tipo, Produto produto, int orderBy) {
		...
		if(tipo == FORM_INSERT || tipo == FORM_UPDATE) {
			...
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Data de venda: <input class=\"input--register\" type=\"text\" name=\"dataVenda\" value=\""+ produto.getDataVenda().toString() + "\"></td>";
			umProduto += "\t\t\t<td>Prazo de entrega: <input class=\"input--register\" type=\"text\" name=\"prazoEntrega\" value=\""+ produto.getPrazoEntrega().toString() + "\"></td>";
			...
			umProduto += "\t\t</tr>";
			umProduto += "\t\t<tr>";
			umProduto += "\t\t\t<td>&nbsp;Data de venda: "+ produto.getDataVenda().toString() + "</td>";
			umProduto += "\t\t\t<td>Prazo de entrega: "+ produto.getPrazoEntrega().toString() + "</td>";
			umProduto += "\t\t\t<td>&nbsp;</td>";
			umProduto += "\t\t</tr>";
			umProduto += "\t</table>";		
		} else {
	...
	public Object insert(Request request, Response response) {
		...
		LocalDateTime dataVenda = LocalDateTime.parse(request.queryParams("dataVenda"));
		LocalDate prazoEntrega = LocalDate.parse(request.queryParams("prazoEntrega"));
		
		String resp = "";
		
		Produto produto = new Produto(-1, nome, preco, quantidade, dataVenda, prazoEntrega);
	...
	public Object update(Request request, Response response) {
        ...
        if (produto != null) {
        	...
        	produto.setDataVenda(LocalDateTime.parse(request.queryParams("dataVenda")));
        	produto.setPrazoEntrega(LocalDate.parse(request.queryParams("prazoEntrega")));
